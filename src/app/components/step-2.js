  ...
  return (
    <section id="step-2">
      ...
      <article id="options-row">
        <section  className={selectedPlan === "Arcade" ? "activePlan plan" : "plan"} onClick={() => handleClick("Arcade")}>
        ...
        <section  className={selectedPlan === "Advanced" ? "activePlan plan" : "plan"}  onClick={() => handleClick("Advanced")}>
        ...
        <section className={selectedPlan === "Pro" ? "activePlan plan" : "plan"}  onClick={() => handleClick("Pro")}>
