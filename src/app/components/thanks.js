...
export default function Thanks() {
    return (
      <section id="thanks" className="main-form">
      ...
      <h1 style={{paddingTop: "3rem"}}>Thank you!</h1>
    
      <p id="thanks-note">Thanks for confirming your subscription! We hope you have fun 
